...
int MotionPin = 46;
//int value = 0;
Stepper stepper1(STEPS, Pin0, Pin1, Pin2, Pin3);
Stepper stepper2(STEPS, Pin4, Pin5, Pin6, Pin7);
...
//          //MotionDetected = true;
//          if (MotionDetected == true){
//            Serial.println(F("Motion detected. Opening..."));
//            granted(2800);
//          }
...
//        }
      if ( findID(readCard) ) { // If not, see if the card is in the EEPROM
        ...
        granted(2800);         // Open the door lock for 300 ms
      }
...
///////////StepperCodeV2///////////
// stepper1.setSpeed(1); // 1 rpm
// stepper2.setSpeed(1); // 1 rpm

// stepper1.step(2038);stepper2.step(2038); // do 2038 steps -- corresponds to one revolution in one minute
// delay(1000); // wait for one second
// stepper1.setSpeed(6);stepper2.setSpeed(6); // 6 rpm
// stepper1.step(-2038);stepper2.step(-2038); // do 2038 steps in the other direction with faster speed -- corresponds to one revolution in 10 seconds
}
